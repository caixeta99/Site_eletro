...
if( (isset($_POST['editar'])) and (isset($_POST['id'])) )
{
	...
	$dados_plano_trabalho = $apm_ano_plano_trabalho->find($_POST['id']); 

	if( !( ($apm) and ($dados_plano_trabalho) and ($apm->aa_ano == $date) and ($apm->aa_id == $dados_plano_trabalho->apt_ano) ) ){
...
<link rel="icon" href="Imagens/Imagens estaticas/Icones/icone-etec.png" />
                                           ...
                                           <!-- titulo da pagina -->
<title>APM - Edição do plano de trabalho</title>
...
<main class="etec-admin-pag-padrao">
 <div class="etec-admin-pad-barlateral">
   <div class="etec-admin-pad-bar-info"><h1>Edição do plano de trabalho</h1></div>
...
<form action="admin_apm_plano_trabalho.php" method="post" class="eve-admin-form" >
   ...
   <input type="hidden" name="idApm" value="<?php echo $dados_plano_trabalho->apt_ano; ?>" />
	...
	<form action="admin_apm_plano_trabalho.php" method="post" >
		...
		<div class="etec-admin-pad-forms">
            ...
            <div class="etec-admin-pad-forms-element">
       			<textarea name="descricao"  placeholder="Descrição do plano de trabalho." maxlength="200" id="apm_plano_trabalho" ><?php echo $dados_plano_trabalho->apt_descricao; ?></textarea>
  			</div>
            ...
            <input name="idApm" type="hidden" value="<?php echo $dados_plano_trabalho->apt_ano; ?>" />
            <input name="id" type="hidden" value="<?php echo $dados_plano_trabalho->apt_id; ?>" />
