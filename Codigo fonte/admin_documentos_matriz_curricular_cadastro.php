...
<link rel="icon" href="Imagens/Imagens estaticas/Icones/icone-etec.png" />
                              ...
                              <!-- titulo da pagina -->
<title>Matrizes curriculares - cadastro</title>
...
<form action="admin_documentos_matriz_curricular.php" method="post">
...
?>
 ...
 <div class="etec-admin-pad-conteudo-unit admin-pad-unit-ativar-color">
   ...
   <div class="etec-admin-pad-cont-unit-info-reduces etec-admin-pad-cont-unit-info " >
      <input name="curso_matriz_curricular[<?php echo $i; ?>]" type="checkbox" value="<?php echo $value->c_id; ?>"
           	<?php
