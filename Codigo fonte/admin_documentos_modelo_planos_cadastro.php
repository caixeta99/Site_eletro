...
<main class="etec-admin-pag-padrao">
 <div class="etec-admin-pad-barlateral">
   <div class="etec-admin-pad-bar-info"><h1>Cadastro do documento</h1></div>
   <div class="etec-admin-pad-bar-info"><i>Informativo:</i> Nesta página é possivel realizar o cadastro de um documento.</div>
...
<fieldset>        	  	  
 <form action="admin_documentos_modelo_planos.php" method="post" enctype="multipart/form-data">
  ...
  <p>Documento: </p>
       ...
       <input name="nome_documento" type="text" class="input" id="documento" maxlength="200" minlength="1" value="" placeholder="Nome do documento" />
  </div>
