...
<link rel="icon" href="Imagens/Imagens estaticas/Icones/icone-etec.png" />
                                           ...
                                           <!-- titulo da pagina -->
<title>APM - Cadastro de Membro</title>
...
<main class="etec-admin-pag-padrao">
 <div class="etec-admin-pad-barlateral">
   <div class="etec-admin-pad-bar-info"><h1>Cadastro de membro</h1></div>
   <div class="etec-admin-pad-bar-info"><i>Informativo:</i> Nesta página é possivel realizar o cadastro de um novo membro da APM. Logo abaixo desta mensagem há a seguinte opção:
	...
	<form action="admin_apm_membros.php" method="post" >
		...
		<div class="etec-admin-pad-forms">
   			...
   			<div class="etec-admin-pad-forms-element">
   				<input name="nome" type="text" class="input" maxlength="100" id="membro_nome" placeholder="Nome do membro da APM."/>
  			</div>
			
            <div class="etec-admin-pad-forms-element">
   				<input name="cargo" type="text" class="input" maxlength="100" id="membro_cargo" placeholder="Cargo do membro da APM."/>
  			</div>
            
            <div class="etec-admin-pad-forms-element">
   				<input name="rg" type="text" class="input" maxlength="30" id="membro_rg" placeholder="RG do membro da APM."/>
  			</div>
