...
if((isset($_POST['id']))){
    ...
    $resultado = $DocumentosModeloPlanos->find($id, '', $coordenacao->doc_id);
	
    if((!$resultado)and($resultado->dmp_ano != $coordenacao->doc_id)){
...
<main class="etec-admin-pag-padrao">
 <div class="etec-admin-pad-barlateral">
   ...
   <a href="admin_documentos_modelo_planos.php" ><div class="etec-admin-pad-bar-iten etec-admin-pad-bar-iten-btn " >
   Voltar
   </div></a>
 </div>
...
<fieldset>        	  	  
 <form action="admin_documentos_modelo_planos.php" method="post" enctype="multipart/form-data">
  <div class="etec-admin-pad-forms">
  
    <div class="etec-admin-pad-forms-info ">
  <p>Documento: </p>
  
       <input name="nome_documento" type="text" class="input" id="documento" maxlength="200" minlength="1" value="<?php echo $resultado->dmp_documento;?>"/>
  </div>
...
<div class="button2 button etec-admin-pad-forms-enviar"><input name="editar" type="button" value="Finalizar" /></div>
</div>
</form>
</fieldset>
