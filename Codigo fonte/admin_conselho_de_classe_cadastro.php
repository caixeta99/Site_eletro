...
<link rel="icon" href="Imagens/Imagens estaticas/Icones/icone-etec.png" />
                                           ...
                                           <!-- titulo da pagina -->
<title>Conselho de Classe - Cadastro de arquivo</title>
...
<main class="etec-admin-pag-padrao">
 <div class="etec-admin-pad-barlateral">
   <div class="etec-admin-pad-bar-info"><h1>Cadastro de arquivo</h1></div>
   <div class="etec-admin-pad-bar-info"><i>Informativo:</i> Nesta página é possivel realizar o cadastro de um novo arquivo do conselho de classe. Logo abaixo desta mensagem há a seguinte opção:
		...
		<div class="etec-admin-pad-forms">
   			...
   			<div class="etec-admin-pad-forms-element">
                ...
                <select name="periodo" class="" id="conselho_classe_periodo">
                    ...
                    <option value="Ensino integrado">Ensino integrado</option>
                    <option value="Ensino integrado - Novotec">Ensino integrado - Novotec</option>
                    <option value="Ensino técnico">Ensino técnico</option>
                </select>
  			</div>
			
            <div class="etec-admin-pad-forms-element">
   				<input name="turma" type="text" class="input" maxlength="50" id="conselho_classe_turma" placeholder="Turma."/>
  			</div>
            ...
            <input name="idCC" type="hidden" value="<?php echo $conselho->ccs_id; ?>" id="cadastrar" />
