...
if((isset($_GET['A44dsddERTjsJfdJLsSrEUd566457IfdKddItfAfnNB57hyDVSa56JgSaKPd3U4SFfa4434fdsdsttv5fd3DdfDdDS45S45SDF3']))){
    ...
    $resultado = $DocumentosCoordenacao->find($id);
	
    if((!$resultado)and($resultado->dc_ano != $coordenacao->doc_id)){
...
<fieldset>        	  	  
 <form action="admin_documentos_coordenacao.php" method="post" enctype="multipart/form-data">
  <div class="etec-admin-pad-forms">
  
    <div class="etec-admin-pad-forms-info ">
  <p>Documento: </p>
  
       <input name="documento" type="text" class="input" disabled="disabled" value="<?php echo $resultado->dc_documento;?>"/>
  </div>
   ...
   <input name="id" type="hidden" value="<?php echo $resultado->dc_id; ?>" />
