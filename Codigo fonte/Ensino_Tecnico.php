...
<link rel="stylesheet" href="Css/etec-style-usuario-rest-responsible.css">
                                    ...
                                    <!-- titulo da pagina -->
<title>Cursos Técnicos | Eletrô</title>
...
<div class="main-conteiner"><!--Abertura da class aonde ficara todo o conteudo da pagina -->
 ...
 <header class="etec-container-indicator">
   ...
   <div class="etec-container-indicator-item"> Cursos Técnicos | <a href="index.php">Eletrô</a> </div>
  
 </header><!-- fechamento da class"container-indicator-->

<?php    

foreach($Cursos->findAll('S', 'Noturno') as $key => $value):
 ...
 <div class="etec-curso-integrado-contant">
  <div class="etec-cont-backgroud etec-curso-backgroud etec-curso-integrad-unit">
   <div class="">
    ...
    <div class="etec-curso-integrad-unit-img"><img src="<?php echo $imagem[2]; ?>" title="<?php echo $value->c_titulo; ?>" alt="<?php echo $value->c_titulo; ?>"></div>
    ...
    </div><!--fechamento da class"etec-curso-integrad-unit-text"-->
