...
if((isset($_GET['A44dsddERTjsJfdJLsSrEUd566457IfdKddItfAfnNB57hyDVSa56JgSaKPd3U4SFfa4434fdsdsttv5fd3DdfDdDS45S45SDF3']))){
    ...
    $resultado = $DocumentosPlanoTrabalho->find($id);
	
    if((!$resultado)and($resultado->dpt_ano != $coordenacao->doc_id)){
...
<fieldset>        	  	  
 <form action="admin_documentos_plano_trabalho.php" method="post" enctype="multipart/form-data">
  ...
  <p>Curso: </p>
	...
	<?php  
	    ...
	    //realiza a busca das informações
    $curso = $Cursos->find($resultado->dpt_cursos);
